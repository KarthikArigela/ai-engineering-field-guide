...
| # | Webinar | Date | Status |
|---|---------|------|--------|
| 1 | [A Day of an AI Engineer](01-a-day-of-ai-engineer.md) | Feb 16, 2026 | Recording available |
...
1. A Day of an AI Engineer - The practical reality of the role: core responsibilities, prompt engineering, evaluation datasets, production concerns (A/B testing, monitoring, feedback loops), and the skills a modern AI engineer actually needs.
